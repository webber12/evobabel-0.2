...
$activeRow = '<div class="active"><img src="assets/snippets/evoBabel/config/images/lang_[+alias+].png"> &nbsp;<a href="[+url+]">[+name+]</a></div>';

//неактивный язык списка
$unactiveRow = '<div><img src="assets/snippets/evoBabel/config/images/lang_[+alias+].png"> &nbsp;<a href="[+url+]">[+name+]</a></div>';
